...
b.forEach(button => {
  button.addEventListener('click', async function () {
    ...
    try {
      ...
      const response = await fetch(`https://selfbliss--6.onrender.com/category-products/${categoryId}`);
...
//wishlist.html
    ...
    async function addToWishlist(productId) {
      ...
      try {
        const response = await fetch("https://selfbliss--6.onrender.com/wishlist", {
          method: "POST",
          headers: {
...
//cart.html
  document.addEventListener('DOMContentLoaded', () => {
    ...
    async function addToCart(productId) {
      ...
      try {
        const response = await fetch("https://selfbliss--6.onrender.com/cart", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
